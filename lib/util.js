...
/**
 * Given a lib/location file of a SlimerJS previously installed with NPM,
 * is there a valid SlimerJS binary at this lib/location.
 * @return {Promise<string>} resolved location of phantomjs binary on success
 */
function findValidSlimerJsBinary(libPath) {
...
module.exports = {
  ...
  findValidSlimerJsBinary: findValidPhantomJsBinary,
